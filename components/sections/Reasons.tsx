...
const reasons = [
  {
    icon: Wrench,
    title: "自分の仕事をAIで自動化した実績がある",
    description:
      "口だけではありません。代表自身がマーケティング・営業・コンサルワークのAI自動化パイプラインを設計・運用しています。",
  },
  {
    icon: Target,
    title: "200件超のプロジェクトで\u201cつまずきパターン\u201dを知っている",
    description:
  ...
  },
  {
    ...
    description:
      "バイブコーディングで自動化パイプラインやプロトタイプを即構築。\u201cコンサルが帰った後、何も残らない\u201dは起きません。",
  },
];
